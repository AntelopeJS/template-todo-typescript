...
export declare function fromPlainData<T extends Constructible>(rawObject: Record<string, any>, TableClass: T): InstanceType<T>;
export declare function toPlainData<T extends {
    constructor: any;
...
export declare function toDatabase<T extends {
    constructor: any;
}>(object: T): Record<string, any>;
...
export declare function attachModifier<T extends Constructible, M extends Constructible<Modifier>>(TableClass: T, Modifier: M, field: keyof InstanceType<T>, options: ExtractModifierOptions<InstanceType<M>>): void;
export declare function getModifiedFields<T extends {
    constructor: any;
}, M extends Constructible<Modifier>>(object: T, Modifier: M): (keyof T)[];
export declare function unlock<T extends {
    constructor: any;
