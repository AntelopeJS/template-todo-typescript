...
export declare function DataController<
  C extends Class,
...
export declare const RegisterDataController: () => import('@ajs/core/beta/decorators').ClassDecorator<
  Class<any, any[]>
>;
...
export declare namespace DefaultRoutes {
  ...
  const Delete: {
    ...
    ) => Promise<import('@ajs/database/beta').Result.Write<any>>;
    args: (import('@ajs/core/beta/decorators').PropertyDecorator & ParameterDecorator)[];
    method: string;
  };
  const All: {
