...
export declare namespace Parameters {
  ...
  export const List: () => import('@ajs/core/beta/decorators').PropertyDecorator &
  ...
  export const Get: () => import('@ajs/core/beta/decorators').PropertyDecorator &
    import('@ajs/core/beta/decorators').ParameterDecorator;
  export interface NewParameters {
    noMandatory?: string;
  }
  export const New: () => import('@ajs/core/beta/decorators').PropertyDecorator &
    import('@ajs/core/beta/decorators').ParameterDecorator;
  ...
  export const Edit: () => import('@ajs/core/beta/decorators').PropertyDecorator &
    import('@ajs/core/beta/decorators').ParameterDecorator;
  export interface DeleteParameters {
    id: string[];
  }
  export const Delete: () => import('@ajs/core/beta/decorators').PropertyDecorator &
    import('@ajs/core/beta/decorators').ParameterDecorator;
  export {};
}
export declare namespace Query {
  ...
  function Get(
    table: Table,
    id: string | ValueProxy.Proxy<string>,
    index?: string,
  ): import('@ajs/database/beta').SingleSelection<any>;
  function List<T extends Record<string, any>>(
    obj: any,
    meta: DataAPIMeta,
    request: Stream<T>,
    reqCtx: RequestContext,
    sorting?: [string, boolean | undefined],
    filters?: Record<string, FilterValue>,
  ): [sorted: Stream<T>, total: Datum<number>];
  function Delete(
    table: Table,
    id: string | string[],
  ): import('@ajs/database/beta').Query<import('@ajs/database/beta').Result.Write<any>>;
}
